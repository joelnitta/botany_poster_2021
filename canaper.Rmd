...
This demonstrates the package using the dataset of the paper where CANAPE was first published [@Gonzalez-Orozco2014]: `r ncol(acacia$comm)` species of *Acacia* in Australia distributed over `r nrow(acacia$comm)` sites:
...
<span style='font-size:70%'><div id="refs"></div></span> 
